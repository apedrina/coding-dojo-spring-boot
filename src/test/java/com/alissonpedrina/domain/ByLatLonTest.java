...
import com.alissonpedrina.java17.domain.query.ByLatLon;
...
class ByLatLonTest {
    ...
    private Query query;
    @InjectMocks
    private ByLatLon byLatLon;

    @Test
    void should_process_by_lat_lon() throws IOException {
